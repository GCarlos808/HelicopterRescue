...
template <> constexpr inline auto InputManager::qt_create_metaobjectdata<qt_meta_tag_ZN12InputManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'accionCambiada'
        QtMocHelpers::SignalData<void(enum Accion, bool)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void InputManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->accionCambiada((*reinterpret_cast<std::add_pointer_t<enum Accion>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (InputManager::*)(Accion , bool )>(_a, &InputManager::accionCambiada, 0))
            return;
    }
}
...
// SIGNAL 0
void InputManager::accionCambiada(Accion _t1, bool _t2)
{
